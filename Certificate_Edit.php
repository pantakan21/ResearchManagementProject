...
<html>
    <head>
        ...
        <?php
            //require และเรียกใช้งาน Function FirstCheck_Nav() สำหรับการตรวจว่ามีการ Log in หรือไม่ และดูว่ามี Level ระดับไหนเพื่อเรียก Navigator Bar ได้ถูกอัน
            require("Header2.php");
            require("server.php");
            ...
            <div id="box" class = "gradient-border container bg-white" style = "padding-bottom: 5%">
                <form action = "Certificate_Edit_DB.php" method = "POST" enctype = "multipart/form-data" name = "upfile" id = "upfile" class = "needs-validation" novalidate>  <!-- ส่งข้อมูลไป Certificate_Edit_DB , ถ้าส่งไฟล์ต้อง Encrypt -->
                    ...
                    <div class = "mb-3 col">
                        ...
                        <input name = "Certificate_THName" type = "text" placeholder = "กรุณากรอกชื่อใบประกาศ" minlength="3" class = "form-control" value = "<?php echo $row['Certificate_THName'];?>" autofocus> 
                    ...
                    <div class = "mb-3 col">
                        ...
                        <input name = "Certificate_ENGName" type = "text" placeholder = "กรุณากรอกชื่อใบประกาศ" minlength="3" class = "form-control" value = "<?php echo $row['Certificate_ENGName'];?>"> 
                        <div class = "invalid-feedback">*กรุณากรอกชื่อใบประกาศ(ขั้นต่ำ 3 ตัวอักษร)</div>
                    </div>
