                ...
                <div id="navbar1" class="collapse navbar-collapse">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown me-3">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">สำหรับ Admin</a>
                            <ul class="dropdown-menu">
                                <li><a href="Log_Table.php" class="dropdown-item">Log</a></li>
                                <li><a href="Manage_User.php" class="dropdown-item">การจัดการ</a></li>
                            </ul>
                        </li>
