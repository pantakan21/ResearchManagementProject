...
<html>
    <head>
        <title>Research_EditForAdmin</title>
            ...
            <div id="box" class = "gradient-border container bg-white" style = "padding-bottom: 5%">
                <form action = "Research_Edit_DB.php" method = "POST" enctype = "multipart/form-data" name = "upfile" id = "upfile" class = "needs-validation" novalidate>  <!-- ส่งข้อมูลไป Research_Edit_DB -->
                    ...
                    <div class = "mb-3 col">
                        ...
                        <input name = "Research_THName" type = "text" placeholder = "กรุณากรอกชื่องานวิจัยแก้ไขงานวิจัย" minlength="3" class = "form-control" required value = "<?php echo $row['Research_THName'];?>" autofocus> 
                        <div class = "invalid-feedback">*กรุณากรอกชื่องานวิจัยแก้ไขงานวิจัย(ขั้นต่ำ 3 ตัวอักษร)</div>
                    </div>

                    <div class = "mb-3 col">
                        <label for = "Research_ENGName" class = "form-label">ชื่องานวิจัยภาษาอังกฤษ</label> 
                        <input name = "Research_ENGName" type = "text" placeholder = "กรุณากรอกชื่องานวิจัยแก้ไขงานวิจัย" minlength="3" class = "form-control" required value = "<?php echo $row['Research_ENGName'];?>"> 
                        <div class = "invalid-feedback">*กรุณากรอกชื่องานวิจัยแก้ไขงานวิจัย(ขั้นต่ำ 3 ตัวอักษร)</div>
                    </div>
