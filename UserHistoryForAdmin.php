...
<html>
    <head>
        <title>UserHistoryForAdmin</title>
                            ...
                            <table id = "userdata1" class = "table table-white border table-bordered table-hover table-responsive">  <!-- คุณสมบัติของตารางทั้งหมด -->
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="Research_EditForAdmin.php?id=<?php echo $row1['Research_ID'];?>"><i class="fas fa-edit"></i></td>                            
                                        <td><a href="Research_Delete_DB.php?id=<?php echo $row1['Research_ID'];?>" onclick = "return confirm('ยืนยันการลบข้อมูล');"><i class="fas fa-trash-alt" style = "color:red;"></td>  <!-- ไปยังหน้า Certificate_Delete พร้อมกับ Query String ที่เป็น ID-->
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
                            ...
                            <table id = "userdata2" class = "table table-white border table-bordered table-hover table-responsive">  <!-- คุณสมบัติของตารางทั้งหมด -->
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row2['Account_FName'];?></td>
                                        <td><a href="Certificate_EditForAdmin.php?id=<?php echo $row1['Certificate_ID'];?>"><i class="fas fa-edit"></i></td>                            
